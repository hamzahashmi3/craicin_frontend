      ...
      <section className='bg-checkout-img'>
        ...
        <section>
            <Container className='text-muted'>
                ...
                <p>Bookings can be made via our website at <Link to="/" className='text-success'>www.rabbies.com</Link>, by telephone, <Link to="/contact" className='text-success'>by email</Link>, or in person at our booking office.</p>
                ...
                <Link className='text-success mb-3' to="/faq">https://www.rabbies.com/en/info/about-us/faqs#acc</Link>
                <p>If your complaint is not resolved locally and you wish to complain further then please contact us at feedback@rabbies.com providing all relevant information necessary to enable us to consider your complaint. We would request that any complaints be raised with us within 28 days of the end of your tour, as otherwise our ability to investigate the complaint properly may be affected.</p>
                ...
                <p>Further details of how we process your personal information is set out in our Privacy Policy. Please click <Link className='text-success' to="/privacycookies">here</Link> to review our current Privacy and Cookies Policy, which can also be accessed at <a className='text-success' href="https://www.rabbies.com/en/info/about-us/privacy-cookies">https://www.rabbies.com/en/info/about-us/privacy-cookies</a></p>
                ...
                <p>Any testimonials, photographs or content (which you upload to our websites or otherwise) will be considered non-confidential and non-proprietary (unless expressly stated by you in writing to <a href="mailto:marketing@rabbies.com" className='text-success'>marketing@rabbies.com</a>). You retain all of your ownership rights in your content, but you are required to grant us a licence to use, store and copy that content and to distribute and make it available to third parties. Uploading your content shall automatically grant us a perpetual, worldwide, royalty-free, non-exclusive licence to use, reproduce, distribute and display such content for such purposes as we may reasonably require including, without limitation, for use in our marketing materials and publicity.</p>
